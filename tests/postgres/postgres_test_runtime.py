...
from tests.postgres.support import test_database_url
...
class PostgreSQLRuntimeTest(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        with psycopg.connect(cls.database_url) as connection:
            connection.execute("DROP TABLE garmin_coach_test_harness")
    ...
    def _migration(self, *arguments: str, database_url: str | None = None):
        ...
        environment.update(
            {
                "GARMIN_COACH_DATABASE_URL": database_url or self.database_url,
    ...
    def test_upgrade_is_idempotent_and_records_revision(self) -> None:
        ...
        self.assertEqual(revision, ("0001_runtime_baseline",))
    ...
    def test_current_command_reports_the_applied_revision(self) -> None:
        ...
        self.assertIn("0001_runtime_baseline", current.stdout)
